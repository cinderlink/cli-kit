...
import type { ParsedArgs, ScopeContext, ExitCode } from '@core/model/scope'

/**
 * Base event interface for all CLI events
 */
export interface BaseCLIEvent extends BaseEvent {}
...
/**
 * CLI event channel names - re-exported from core
 */
import { CLIEventChannels } from '@core/model/events/channels'

export { CLIEventChannels }
