...
export const PLUGIN_CONSTANTS = {
  ...
  PLUGIN_FILE_PATTERNS: ['*.plugin.ts', '*.plugin.js', '*-plugin.ts', '*-plugin.js'] as const,
...
export const REGISTRY_CONSTANTS = {
  ...
  RESERVED_COMMANDS: ['help', 'version', 'completion', 'config', 'plugin', 'debug'] as const,
...
export const DEBUG_CONSTANTS = {
  /** Debug scopes */
  DEBUG_SCOPES: ['cli:parser', 'cli:registry', 'cli:plugin', 'cli:runner', 'cli:config'] as const,
