...
export function DebugWrapper({ children }: DebugWrapperProps): JSX.Element {
  ...
  const header = jsx('box', { 
    ...
    jsx('hstack', {},
      ...
      jsx('text', {}, ' | '),
      jsx('text', { style: { dim: true } }, `Commands: ${commandScopes.length} | Plugins: ${pluginScopes.length} | Total Scopes: ${scopes.length}`)
    )
  )
  
  // Create debug info panel
  const debugInfo = jsx('box', {
    border: 'single',
    borderColor: 'gray',
    padding: 1
  },
