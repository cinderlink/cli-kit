...
export interface InputService extends Context.Tag<"InputService", {
  ...
  readonly filterKeys: (predicate: (key: import('./schemas').KeyEvent) => boolean) => Stream.Stream<import('./schemas').KeyEvent, InputError, never>
  readonly mapKeys: <T>(mapper: (key: import('./schemas').KeyEvent) => T | null) => Stream.Stream<T, InputError, never>
  readonly debounceKeys: (ms: number) => Stream.Stream<import('./schemas').KeyEvent, InputError, never>
  readonly parseAnsiSequence: (sequence: string) => Effect.Effect<import('./schemas').KeyEvent | null, InputError, never>
...
export interface RendererService extends Context.Tag<"RendererService", {
  ...
  readonly renderBatch: (views: ReadonlyArray<{ view: View; x: number; y: number }>) => Effect.Effect<void, RenderError, never>
  ...
  readonly measureText: (text: string) => Effect.Effect<{ width: number; height: number; lineCount: number }, RenderError, never>
  readonly wrapText: (text: string, width: number, options?: { wordWrap?: boolean; breakWords?: boolean }) => Effect.Effect<ReadonlyArray<string>, RenderError, never>
  readonly truncateText: (text: string, width: number, ellipsis?: string) => Effect.Effect<string, RenderError, never>
  ...
  readonly renderToLayer: (layerName: string, view: View, x: number, y: number) => Effect.Effect<void, RenderError, never>
  readonly setLayerVisible: (layerName: string, visible: boolean) => Effect.Effect<void, RenderError, never>
...
export interface StorageService extends Context.Tag<"StorageService", {
  ...
  readonly createBackup: (filePath: string, backupSuffix?: string) => Effect.Effect<string, StorageError, never>
  readonly restoreBackup: (filePath: string, backupPath: string) => Effect.Effect<void, StorageError, never>
  readonly listBackups: (filePath: string) => Effect.Effect<ReadonlyArray<string>, StorageError, never>
  readonly cleanupBackups: (filePath: string, keepCount: number) => Effect.Effect<void, StorageError, never>
  readonly beginTransaction: Effect.Effect<string, StorageError, never>
  readonly addToTransaction: (transactionId: string, operation: 'write' | 'delete', path: string, content?: string) => Effect.Effect<void, StorageError, never>
  readonly commitTransaction: (transactionId: string) => Effect.Effect<void, StorageError, never>
  readonly rollbackTransaction: (transactionId: string) => Effect.Effect<void, StorageError, never>
}> {}
