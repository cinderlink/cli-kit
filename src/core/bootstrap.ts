...
// Coordination module
import { CoordinationModule } from './coordination/module'

// Component system module
import { ComponentSystemModule } from '../components/module'
...
export function bootstrap(config: BootstrapConfig = {}): Effect<ModuleRegistry, Error> {
  return Effect.gen(function* () {
    ...
    if (config.enableComponentSystem) {
      const componentSystemModule = new ComponentSystemModule(eventBus)
      yield* registry.register(componentSystemModule)
    }
...
export interface BootstrapResult {
  ...
  readonly modules: {
    ...
    readonly componentSystem?: ComponentSystemModule
  }
}
  ...
  return Effect.gen(function* () {
    ...
    const result: BootstrapResult = {
      ...
      modules: {
        ...
        componentSystem: registry.getModule<ComponentSystemModule>('component-system')
      }
    }
