 ...
 * ```
 */
export const style = (): Style => new Style({ props: {} })
 ...
 * ```
 */
export const styleFrom = (props: StyleProps): Style => new Style({ props })
...
export const Styles = {
   ...
   * Highlighted text
   */
  Highlight: style().foreground(Colors.black).background(Colors.yellow),

  /**
   * Simple box with rounded borders
   */
  Box: style().border(Borders.Rounded).padding(1, 2),

  /**
   * Title/header styling
   */
  Title: style().bold().foreground(Colors.white).marginBottom(1),

  /**
   * Subtitle styling
   */
  Subtitle: style().foreground(Colors.gray).marginBottom(1),
   ...
   * Full-width block
   */
  Block: style().width(100).maxWidth(100),
} as const
