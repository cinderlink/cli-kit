...
import { EventBus, BaseEvent, generateId } from '../../../model/events/event-bus'
import type { ScopeContext } from '../../../model/scope/types'
import { $state, $derived, $effect, type StateRune, type DerivedRune } from '@core/update/reactivity/runes'
import type { Component, View } from '../../../types/core'
