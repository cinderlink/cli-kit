...
export const DEPENDENCY_CONSTANTS = {
  ...
  /** Dependency types */
  DEPENDENCY_TYPES: ['required', 'optional', 'peer', 'dev'] as const,
} as const
...
export const SECURITY_CONSTANTS = {
  /** Permission types */
  PERMISSION_TYPES: ['filesystem', 'network', 'process', 'environment', 'system'] as const,
  ...
  /** Security levels */
  SECURITY_LEVELS: ['unrestricted', 'standard', 'restricted', 'sandbox'] as const,
} as const
...
export const DEV_CONSTANTS = {
  ...
  IS_DEV_MODE: process.env.NODE_ENV === 'development' || process.env.TUIX_DEV === 'true',
