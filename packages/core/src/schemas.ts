...
export type Cmd<T = unknown> = z.infer<typeof CmdSchema>
export type Component<Model = unknown, Msg = unknown> = z.infer<typeof ComponentSchema>
...
export const validateView = (data: unknown): data is View => {
...
export const parseView = (data: unknown): View => {
