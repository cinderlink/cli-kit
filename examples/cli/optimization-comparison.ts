    ...
    apis: {
      ...
      handler: () => {
        return vstack(
          ...
          text(""),
          text("// Original:"),
          text('import { stringWidth } from "cli-kit/utils/string-width"'),
          text('const width = stringWidth("text")'),
          text(""),
          text("// Optimized:"),
          text('import { stringWidthOptimized } from "cli-kit/utils/string-width-optimized"'),
    ...
    migration: {
      ...
      handler: () => {
        return vstack(
          ...
          text('  import { globalViewCache } from "cli-kit/core/view-cache"'),
          ...
          text('  import { createLazyHandler } from "cli-kit/cli/lazy-cache"'),
